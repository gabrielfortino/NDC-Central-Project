public class MessageSender {
    ...
    public static byte[] requestConfigIDMessage() {
        ...
        return new byte[]{0x31, 0x1C, 0x30, 0x33, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x1C, 0x1C, 0x33, 0x00};
    }

    public static byte[] goInServiceMessage(){
        return new byte[]{
                0x31, 0x1C, 0x30, 0x33, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x1C, 0x1C, 0x31, 0x00
        };
    }

    public static byte[] goOutServiceMessage(){
        return new byte[]{
                0x31, 0x1C, 0x30, 0x33, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x1C, 0x1C, 0x32, 0x00
        };
    }
    ...
    public static byte[] configurationParameterLoadMessage() {
        return new byte[]{
                0x33, 0x1C, 0x30, 0x33, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x1C, 0x1C, 0x31, 0x33, 0x1C, 0x1C, 0x30, 0x33, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x1C, 0x00
        };
...
//                0x00
    ...
    public static byte[] stateTableLoadMessage(){
        return new byte[]{
               0x33, 0x1C, 0x30, 0x33, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x1C, 0x1C, 0x31,0x36, 0x1C, 0x31, 0x30, 0x31, 0x30, 0x00        };
    }

    public static byte[] configurationIDNumberLoadMessage() {
        return new byte[]{
                0x34, 0x37, 0x33, 0x33, 0x30, 0x30, 0x31, 0x33, 0x31, 0x30, 0x30, 0x30, 0x30,
        };
    }
